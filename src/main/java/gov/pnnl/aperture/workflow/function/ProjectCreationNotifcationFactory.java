 ...
 */
public class ProjectCreationNotifcationFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory {
     ...
     */
    public ProjectCreationNotifcationFactory(final ApertureSettings apertureSettings) {
    ...
    protected void getVelocityParamsForView(final Map<String, Object> velocityParams, final AbstractDescriptor descriptor) {
        ...
        velocityParams.put("users", apertureSettings.getCustomField(ApertureSettings.CustomField.USERS));
        velocityParams.put("groups", apertureSettings.getCustomField(ApertureSettings.CustomField.GROUPS));
    }
